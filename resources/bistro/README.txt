...
with additional material parameters specified in the accompanying .pyscene scene file.
...
- Pyscene scene files for Falcor containing additional parameters for select scenes. Refer to Falcor documentation on Scene Formats for more details.

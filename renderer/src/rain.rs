...
impl Particle {
    #[inline]
    pub fn new(rng: &mut impl Rng, p0: Point3<f32>, p1: Point3<f32>) -> Self {
        Self {
            position: Vector3::new(rng.gen_range(p0.x, p1.x), p1.y, rng.gen_range(p0.z, p1.z)),

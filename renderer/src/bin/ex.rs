...
struct RunContext<'a> {
    pub event_loop: &'a mut glutin::EventsLoop,
    pub gl_window: &'a mut glutin::GlWindow,
    pub gl: &'a gl::Gl,
    pub run_index: &'a usize,
}
...
struct SimulateContext<'a> {
    pub event_loop: &'a mut glutin::EventsLoop,
    pub running: &'a mut bool,
    pub simulate_index: &'a usize,
}
